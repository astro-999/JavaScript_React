...
function About() {
    return (
        <div className="About" style={{padding: '20px', textAlign: 'center'}}>
            ...
            <p className='text-warning-emphasis'>This is the about page of our website. We are a team of passionate developers who love to create amazing web applications.</p>
            <div style={{display: 'flex', justifyContent: 'center', gap: '20px', flexWrap: 'wrap'}}>
              <div className='card' style={{width: '200px', padding: '10px', border: '1px solid #ccc', borderRadius: '5px'}}>
